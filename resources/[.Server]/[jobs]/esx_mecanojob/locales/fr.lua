Locales['fr'] = {
  ...
  ['craft']                     = 'etabli',
  ['craft_menu']                = "appuyez sur ~INPUT_CONTEXT~ pour accéder au menude l'établi.",
  ['billing']                   = 'facturation',
  ['hijack']                    = 'crocheter',
  ['repair']                    = 'réparer',
  ['clean']                     = 'nettoyer',
  ...
  ['no_vehicle_nearby']         = "il n'y a pas de véhicule proche",
  ...
  ['imp_flatbed']               = '~r~Impossible! ~s~Vous devez avoir un ~b~plateau ~s~pour ça',
  ['objects']                   = 'objets',
  ['roadcone']                  = 'plot',
  ...
  ['must_in_flatbed']           = 'Vous devez avoir un plateau pour commencer la mission',
