Config.Jobs.tailor = {
  ...
  Zones = {
    CloakRoom = {
      Pos   = {x = 706.735412597656, y = -960.902893066406, z = 29.395324707031},
      ...
      GPS = {x = 740.808776855469, y = -970.066650390625, z = 23.469390869140}
    },

    Wool = {
      Pos   = {x = 1978.92407226563, y = 5171.70166015625, z = 46.63911819458},
      Size  = {x = 3.0, y = 3.0, z = 1.0},
      Color = {r = 204, g = 204, b = 0},
      Marker= 1,
      Blip  = true,
      ...
      Hint  = _U('dd_pickup'),
      GPS = {x = 715.954650878906, y = -959.639587402344, z = 29.395324707031}
    },

    Fabric = {
      Pos   = {x = 715.954650878906, y = -959.639587402344, z = 29.395324707031},
      Size  = {x = 3.0, y = 3.0, z = 1.0},
      Color = {r = 204, g = 204, b = 0},
      Marker= 1,
      Blip  = false,
      ...
      GPS = {x = 712.9282836914, y = -970.5869140625, z = 29.3953247070}
    },

    Clothe = {
      Pos   = {x = 712.9282836914, y = -970.5869140625, z = 29.3953247070},
      Size  = {x = 3.0, y = 3.0, z = 1.0},
      Color = {r = 204, g = 204, b = 0},
      Marker= 1,
      Blip  = false,
