...
Config.RealWeapons = {
	...
	--{name = 'WEAPON_HAMMER', 			bone = 24818, x = -0.45, y = -0.12, yf = -0.10, z = -0.1, xRot = 0.0, yRot = 90.0, zRot = 0.0, category = 'melee', 		model = 'prop_tool_hammer'},
	{name = 'WEAPON_BAT', 				bone = 24818, x = 0.3, y = -0.14, yf = -0.12, z = -0.11, xRot = 0.0, yRot = 300.0, zRot = 0.0, category = 'melee', 		model = 'w_me_bat'},
	{name = 'WEAPON_GOLFCLUB', 			bone = 24818, x = 0.3, y = -0.14, yf = -0.12, z = -0.11, xRot = 0.0, yRot = 300.0, zRot = 0.0, category = 'melee', 		model = 'w_me_gclub'},
	{name = 'WEAPON_CROWBAR', 			bone = 24818, x = 0.0, y = -0.14, yf = -0.12, z = 0.09, xRot = 0.1, yRot = 120.0, zRot = 0.0, category = 'melee', 		model = 'w_me_crowbar'},
	...
	{name = 'WEAPON_HATCHET', 			bone = 24818, x = 0.1, y = -0.14, yf = -0.12, z = -0.11, xRot = 0.0, yRot = 300.0, zRot = 0.0, category = 'melee', 		model = 'w_me_hatchet'},
	{name = 'WEAPON_MACHETE', 			bone = 24818, x = 0.25, y = -0.14, yf = -0.12, z = -0.11, xRot = 0.0, yRot = 300.0, zRot = 0.0, category = 'melee', 		model = 'prop_ld_w_me_machette'},
	...
	--{name = 'WEAPON_PISTOL', 			bone = 51826, x = -0.01, y = 0.10, yf = 0.1, z = 0.07,  xRot = -115.0, yRot = 0.0,  zRot = 0.0, category = 'handguns', 	model = 'w_pi_pistol'},
	--{name = 'WEAPON_COMBATPISTOL', 		bone = 51826, x = -0.01, y = 0.10, yf = 0.1, z = 0.07,  xRot = -115.0, yRot = 0.0,  zRot = 0.0, category = 'handguns', 	model = 'w_pi_combatpistol'},
	{name = 'WEAPON_APPISTOL', 			bone = 51826, x = -0.01, y = 0.10, yf = 0.1, z = 0.07,  xRot = -115.0, yRot = 0.0,  zRot = 0.0, category = 'handguns', 	model = 'w_pi_appistol'},
	{name = 'WEAPON_PISTOL50', 			bone = 51826, x = -0.01, y = 0.10, yf = 0.1, z = 0.07,  xRot = -115.0, yRot = 0.0,  zRot = 0.0, category = 'handguns', 	model = 'w_pi_pistol50'},
	...
	--{name = 'WEAPON_HEAVYPISTOL', 		bone = 51826, x = -0.01, y = 0.10, yf = 0.1, z = 0.07,  xRot = -115.0, yRot = 0.0,  zRot = 0.0, category = 'handguns', 	model = 'w_pi_heavypistol'},
	...
	{name = 'WEAPON_FLAREGUN', 			bone = 58271, x = -0.01, y = 0.1, yf = 0.1, z = -0.07, xRot = -55.0,  yRot = 0.10, zRot = 0.0, category = 'handguns', 	model = 'w_pi_flaregun'},
	--{name = 'WEAPON_MARKSMANPISTOL', 	bone = 58271, x = -0.01, y = 0.1,  z = -0.07, xRot = -55.0,  yRot = 0.10, zRot = 0.0, category = 'handguns', 	model = ''},--
	{name = 'WEAPON_REVOLVER', 			bone = 58271, x = -0.01, y = 0.1, yf = 0.1, z = -0.07, xRot = -55.0,  yRot = 0.10, zRot = 0.0, category = 'handguns', 	model = 'w_pi_revolver'},
	{name = 'WEAPON_STUNGUN', 			bone = 58271, x = -0.01, y = 0.1, yf = 0.1,  z = -0.07, xRot = -55.0,  yRot = 0.10, zRot = 0.0, category = 'handguns', 	model = 'w_pi_stungun'},

	--{name = 'WEAPON_MICROSMG', 			bone = 24818, x = 0.0, y = -0.15, yf = -0.12, z = 0.0, xRot = 0.0, yRot = 135.0, zRot = 0.0, category = 'machine', 	model = 'w_sb_microsmg'},
	...
	{name = 'WEAPON_GUSENBERG', 		bone = 24818, x = 0.1, y = -0.15, yf = -0.12, z = 0.0, xRot = 0.0, yRot = 135.0, zRot = 0.0, category = 'machine', 	model = 'w_sb_gusenberg'},
	...
	{name = 'WEAPON_ASSAULTSMG', 		bone = 24818, x = -0.05, y = -0.15, yf = -0.12, z = -0.08, xRot = 0.0, yRot = 135.0, zRot = 0.0, category = 'machine', 	model = 'w_sb_assaultsmg'},
	{name = 'WEAPON_MINISMG', 			bone = 58271, x = -0.01, y = 0.1, yf = -0.12,  z = -0.07, xRot = -55.0,  yRot = 0.10, zRot = 0.0, category = 'machine', 	model = 'w_sb_minismg'},

	{name = 'WEAPON_ASSAULTRIFLE', 		bone = 24818, x = 0.1, y = -0.15, yf = -0.12, z = 0.0, xRot = 0.0, yRot = 135.0, zRot = 0.0, category = 'assault', 	model = 'w_ar_assaultrifle'},
	{name = 'WEAPON_CARBINERIFLE', 		bone = 24818, x = 0.1, y = -0.15, yf = -0.12, z = 0.0, xRot = 0.0, yRot = 135.0, zRot = 0.0, category = 'assault', 	model = 'w_ar_carbinerifle'},
	...
	{name = 'WEAPON_COMPACTRIFLE', 		bone = 24818, x = 0.15, y = -0.15, yf = -0.12, z = 0.1, xRot = 0.0, yRot = 135.0, zRot = 0.0, category = 'assault', 	model = 'w_ar_assaultrifle_smg'},

	{name = 'WEAPON_PUMPSHOTGUN', 		bone = 24818, x = 0.1, y = -0.15, yf = -0.12, z = 0.0, xRot = 0.0, yRot = 135.0, zRot = 0.0, category = 'shotgun', 	model = 'w_sg_pumpshotgun'},
	{name = 'WEAPON_SAWNOFFSHOTGUN', 	bone = 24818, x = 0.2, y = -0.15, yf = -0.12, z = 0.1, xRot = 0.0, yRot = 135.0, zRot = 0.0, category = 'shotgun', 	model = 'w_sg_sawnoff'},
	...
	{name = 'WEAPON_MUSKET', 			bone = 24818, x = 0.2, y = -0.15, yf = -0.12, z = 0.1, xRot = 0.0, yRot = 135.0, zRot = 0.0, category = 'shotgun', 	model = 'w_ar_musket'},
	...
	{name = 'WEAPON_HEAVYSNIPER', 		bone = 24818, x = 0.1, y = -0.15, yf = -0.12, z = -0.07, xRot = 0.0, yRot = 180.0, zRot = 0.0, category = 'sniper', 	model = 'w_sr_heavysniper'},
	...
	--{name = 'WEAPON_STICKYBOMB', 		bone = 58271, x = -0.01, y = 0.1,  z = -0.07, xRot = -55.0,  yRot = 270.0, zRot = 0.0, category = 'thrown', 	model = 'prop_bomb_01_s'},--
	--{name = 'WEAPON_MOLOTOV', 			bone = 58271, x = -0.01, y = 0.1, yf = 0.1,  z = -0.07, xRot = -55.0,  yRot = 270.0, zRot = 0.0, category = 'thrown', 	model = 'w_ex_molotov'},
	...
	--{name = 'WEAPON_GRENADE', 			bone = 58271, x = -0.01, y = 0.1, yf = 0.1, z = -0.07, xRot = -55.0,  yRot = 270.0, zRot = 0.0, category = 'thrown', 	model = 'w_ex_grenadefrag'},
	...
	{name = 'WEAPON_BZGAS', 			bone = 58271, x = -0.01, y = 0.1, yf = 0.1, z = -0.07, xRot = -55.0,  yRot = 270.0, zRot = 0.0, category = 'thrown', 	model = 'w_ex_grenadesmoke'},
	...
	{name = 'WEAPON_POOLCUE', 			bone = 24818, x = -0.15, y = -0.14, yf = -0.12, z = 0.11, xRot = 0.0, yRot = 300.0, zRot = 0.0, category = 'others', 	model = 'prop_pool_cue'},
	{name = 'WEAPON_WRENCH', 			bone = 24818, x = 0.15, y = -0.14, yf = -0.12, z = -0.11, xRot = 0.0, yRot = 300.0, zRot = 0.0, category = 'others', 	model = 'w_me_wrench'},
