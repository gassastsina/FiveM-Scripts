...
local atms = {
  ...
  {name="ATM", id=277, x=146.9176, y=-1035.455, z=29.343},
  ...
  {name="ATM", id=277, x=213.094, y=-914.647, z=30.692},
  {name="ATM", id=277, x=-563.932, y=282.174, z=82.176},
}
...
local banks = {
  ...
  {name="Banque", id=108, x=1175.51, y=2705.96, z=38.09}
}
...
function IsNearATM()
  ...
  for _, item in pairs(atms) do
    ...
    if(distance <= 1) then --distance de l'atm/banque
      return true
    end
  end
end
...
AddEventHandler('banking:updateBalance', function(balance, name)
  local id = PlayerId()
