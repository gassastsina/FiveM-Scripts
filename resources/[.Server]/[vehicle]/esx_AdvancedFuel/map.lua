...
local blips = {
    ...
    --Captain Fishing
    {name=blipNameFuelBoat,id=427,x=-1602.484,y=5258.328,z=1.000},

    --------- AVIONS ---------
    --{name = blipNameFuelAvions, id=251,x=2133.268,y=4783.649,z=40.97}, --Grapseed
    {name = blipNameFuelAvions, id=251, x = 1412.608, y = 3011.984, z = 40.532},
    {name = blipNameFuelAvions, id=251, x = -1229.625, y = -2877.264, z = 13.945},
    {name = blipNameFuelAvions, id=251, x = 2110.616, y = 4769.587, z = 40.173},

    --------- Helicopters ---------
    {name = blipNameFuelHeli, id=43, x = 1770.241, y = 3239.716, z = 42.127},
    {name = blipNameFuelHeli, id=43, x = -1112.407, y = -2883.893, z = 13.946},
    {name = blipNameFuelHeli, id=43, x = 2085.111, y = 4739.397, z = 40.408}
}
...
--Peut causer des problèmes de changer le s avec la vente en fonction des s en DB avec SAP
boat_stations = {
    ...
    --Captain Fishing
    {x=-1602.484,y=5258.328,z=1.500, s=29}
}

--Peut causer des problèmes de changer le s avec la vente en fonction des s en DB avec SAP
avion_stations = {
    --{x=2133.268, y=4783.649, z=40.97, s=29},
    {x=1412.608,y=3011.984,z=40.532,s=30},
    {x=-1229.625,y=-2877.264,z=13.945,s=31},
    {x = 2110.616, y = 4769.587, z = 40.173, s=32}	--RAD
}
...
heli_stations = {
    ...
    {x = 2085.111, y = 4739.397, z = 40.408, s=35}	--RAD
}
...
--Captain Fishing
stationsText[29] = {x=-1602.484,y=5258.328,z=2.800}


--- Avions stations
stationsText[30] = {x=1412.608,y=3011.984,z=40.532}
stationsText[31] = {x=-1229.625,y=-2877.264,z=15.921}
stationsText[32] = {x = 2110.616, y = 4769.587, z = 41.500}	--RAD

--- Helicopters stations
stationsText[33] = {x=1770.241,y=3239.716,z=45.127}
stationsText[34] = {x=-1112.407,y=-2883.893,z=17.000}
stationsText[35] = {x = 2085.111, y = 4739.397, z = 42.000}	--RAD
